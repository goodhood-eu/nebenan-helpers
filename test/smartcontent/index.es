...
describe('modules/smartcontent', () => {
  ...
  it('process - brackets', () => {
    ...
    const expected = 'abra (cababra <a href="http://google.com/awesome" target="_blank" rel="noopener noreferrer nofollow">google.com/…</a>) etc etc';
    const expectedShort1 = 'abra (cababra <a href="http://google.com/awesome" target="_blank" rel="noopener noreferrer nofollow">google.com/…</a>…';
  ...
  it('process - URL detection', () => {
    ...
    const expectedDomainLike = '<a href="http://ab.cd" target="_blank" rel="noopener noreferrer nofollow">ab.cd</a>.e';

    const domainLikeTypo = 'hallo ich wohnein.berlin :)';

    const short = 'a google.com: b c';
    const expectedShort = 'a <a href="http://google.com" target="_blank" rel="noopener noreferrer nofollow">google.com</a>: b c';

    const shortQuot = 'a "geekhack.com" b c';
    const expectedShortQuot = 'a &quot;<a href="http://geekhack.com" target="_blank" rel="noopener noreferrer nofollow">geekhack.com</a>&quot; b c';

    const shortQuotDot = 'test link:            "google.com".';
    const expectedShortQuotDot = 'test link: &quot;<a href="http://google.com" target="_blank" rel="noopener noreferrer nofollow">google.com</a>&quot;.';

    const short2 = 'a google.com/awesome b';
    const expectedShort2 = 'a <a href="http://google.com/awesome" target="_blank" rel="noopener noreferrer nofollow">google.com/…</a> b';

    const short3 = 'a google.com?q=awesome b';
    const expectedShort3 = 'a <a href="http://google.com?q=awesome" target="_blank" rel="noopener noreferrer nofollow">google.com/…</a> b';

    const short4 = 'a google.com/awesome?q=query#hasharooo b';
    const expectedShort4 = 'a <a href="http://google.com/awesome?q=query#hasharooo" target="_blank" rel="noopener noreferrer nofollow">google.com/…</a> b';
    ...
    const expectedLongText = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer nofollow">https://www.facebook.com</a>';

    const typo = 'sometext,awesome-google.com ok';

    const typo2 = 'wow -http://google.com ok';
    const expectedTypo2 = 'wow -<a href="http://google.com" target="_blank" rel="noopener noreferrer nofollow">http://google.com</a> ok';
  ...
  it('process - weird URL detection', () => {
    ...
    const expectedDash = 'Foo <a href="http://www.erlangen.de/desktopdefault.aspx/tabid-1419/" target="_blank" rel="noopener noreferrer nofollow">http://www.erlangen.de/…</a> bar';

    const punctuation = '<www.weser-kurier.de> (www.google.com)';
    const expectedPunctuation = '&lt;<a href="http://www.weser-kurier.de" target="_blank" rel="noopener noreferrer nofollow">www.weser-kurier.de</a>&gt; (<a href="http://www.google.com" target="_blank" rel="noopener noreferrer nofollow">www.google.com</a>)';

    const port = 'foo http://nebenan.de:3000/groups/170 bar';
    const expectedPort = 'foo <a href="http://nebenan.de:3000/groups/170" target="_blank" rel="noopener noreferrer nofollow">http://nebenan.de/…</a> bar';

    const quote = 'beep http://example.com/foo/bar/cap\'n_penis.jpg boop';
    const expectedQuote = 'beep <a href="http://example.com/foo/bar/cap\'n_penis.jpg" target="_blank" rel="noopener noreferrer nofollow">http://example.com/…</a> boop';

    const comma = 'beep www.weser-kurier.de/bremen_artikel,-Feuerwehreinsatz-immer-noch-im-Einsatz-_arid,1450695.html, boop';
    const expectedComma = 'beep <a href="http://www.weser-kurier.de/bremen_artikel,-Feuerwehreinsatz-immer-noch-im-Einsatz-_arid,1450695.html" target="_blank" rel="noopener noreferrer nofollow">www.weser-kurier.de/…</a>, boop';

    const hash = 'beep http://example.com/#page=shitAngularApp boop';
    const expectedHash = 'beep <a href="http://example.com/#page=shitAngularApp" target="_blank" rel="noopener noreferrer nofollow">http://example.com/…</a> boop';
    ...
    const expectedGoogleMaps = '(<a href="https://www.google.de/maps/place/Helenesee/@52.2772037,14.4919374,16z/data=!4m5!3m4!1s0x4707963a01c5d239:0xa6409c84f3d67066!8m2!3d52.269166!4d14.4877058" target="_blank" rel="noopener noreferrer nofollow">https://www.google.de/…</a>)';

    const wiki = 'a https://en.wikipedia.org/wiki/Scrum_(software_development) b';
    const expectedWiki = 'a <a href="https://en.wikipedia.org/wiki/Scrum_(software_development)" target="_blank" rel="noopener noreferrer nofollow">https://en.wikipedia.org/…</a> b';

    const query = 'a example.com?query=a,b,c q';
    const expectedQuery = 'a <a href="http://example.com?query=a,b,c" target="_blank" rel="noopener noreferrer nofollow">example.com/…</a> q';
    ...
    const expectedJava = 'a <a href="https://www.rsb-online.de/konzerte/konzertkalender/index_ger.html?eventId=56267&ACTION_OPASCALENDAR=displayEvent&lang=ger&startdate=2017/1/19&year:int=2017&month:int=1" target="_blank" rel="noopener noreferrer nofollow">https://www.rsb-online.de/…</a> b';

    const quot = 'a "https://en.wikipedia.org/wiki/Scrum_(software_development)" b';
    const expectedQuot = 'a &quot;<a href="https://en.wikipedia.org/wiki/Scrum_(software_development)" target="_blank" rel="noopener noreferrer nofollow">https://en.wikipedia.org/…</a>&quot; b';

    const native1 = 'a http://google.com?search=wo+ist+Ausländerbehörde b';
    const expectedNative1 = 'a <a href="http://google.com?search=wo+ist+Ausländerbehörde" target="_blank" rel="noopener noreferrer nofollow">http://google.com/…</a> b';

    const native2 = 'a http://google.com?search=ЖЕПЪ b';
    const expectedNative2 = 'a <a href="http://google.com?search=ЖЕПЪ" target="_blank" rel="noopener noreferrer nofollow">http://google.com/…</a> b';

    const native3 = 'пы http://жепь.рф/ебрило.jpg щъ';
    const expectedNative3 = 'пы <a href="http://жепь.рф/ебрило.jpg" target="_blank" rel="noopener noreferrer nofollow">http://жепь.рф/…</a> щъ';

    const native4 = 'щачло https://жепь.рф/ебрило.png?тест=правда&картинка=пепяка.jpg#еще=ф,е,н-х/у/й; попячъ';
    const expectedNative4 = 'щачло <a href="https://жепь.рф/ебрило.png?тест=правда&картинка=пепяка.jpg#еще=ф,е,н-х/у/й" target="_blank" rel="noopener noreferrer nofollow">https://жепь.рф/…</a>; попячъ';
  ...
  it('process - URL shortening', () => {
    ...
    const expected = 'Check this out: <a href="http://google.com/?q=robot+unicorn+porn+three+robot+girls+polish+his+horn" target="_blank" rel="noopener noreferrer nofollow">http://google.com/…</a>…';
  ...
  it('text - weird symbols parsing', () => {
    ...
    const expected = '🕹❤️🚜 <a href="http://apple.com" target="_blank" rel="noopener noreferrer nofollow">apple.com</a><br /><br />çÿkä (błÿåt&gt; <a href="http://google.com" target="_blank" rel="noopener noreferrer nofollow">google.com</a> ҳӯй…';
